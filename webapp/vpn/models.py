...
class VPNTunnel(models.Model):
    ...
    local_id = models.CharField(max_length=255, help_text="Local identity (IP, hostname, or IKE ID)")
    remote_id = models.CharField(max_length=255, help_text="Remote identity (IP, hostname, or IKE ID)")
